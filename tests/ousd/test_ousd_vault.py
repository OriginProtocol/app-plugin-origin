...
def test_ousd_vault_mint_dai(backend, firmware, navigator, test_name, wallet_addr):
    ...
    run_test(contract_ousd_vault, data, backend, firmware, navigator, test_name, wallet_addr)

def test_ousd_vault_mint_usdc(backend, firmware, navigator, test_name, wallet_addr):
    data = contract_ousd_vault.encodeABI("mint", [
...
def test_ousd_vault_mint_usdt(backend, firmware, navigator, test_name, wallet_addr):
    data = contract_ousd_vault.encodeABI("mint", [
...
def test_ousd_vault_redeem(backend, firmware, navigator, test_name, wallet_addr):
